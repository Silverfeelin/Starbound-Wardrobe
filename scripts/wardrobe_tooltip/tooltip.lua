...
require "/scripts/wardrobe_tooltip/scriptHooks.lua"
require "/scripts/wardrobe_tooltip/tooltip_util.lua"
...
function tooltip.init()
  ...
  tooltip.config = root.assetJson("/scripts/wardrobe_tooltip/tooltip.config")
...
function tooltip.drawTab(ttip, tPos, tSize)
  ...
  if ttip.direction == "left" then -- Right
    ...
    pos[2] = tPos[2]
    tab = "/interface/wardrobe_tooltip/tabright.png"
  elseif ttip.direction == "right" then -- Left
    pos[1] = tPos[1] - tSize[1] / 2
    pos[2] = tPos[2]
    tab = "/interface/wardrobe_tooltip/tableft.png"
  elseif ttip.direction == "top" then -- Bottom
    pos[1] = tPos[1]
    pos[2] = tPos[2] - tSize[2] / 2
    tab = "/interface/wardrobe_tooltip/tabdown.png"
  elseif ttip.direction == "bottom" then -- Top
    pos[1] = tPos[1]
    pos[2] = tPos[2] + tSize[2] / 2
    tab = "/interface/wardrobe_tooltip/tabup.png"
  end
